import { Image, Container, Title, List, ThemeIcon } from "@mantine/core";
import {
			...
			<Container>
				<div className={classes.inner}>
					<div className={classes.contentBelowImage}>
						<Title className={classes.title}>
							Thank you for checking out our <br></br>{" "}
				...
				<div className={classes.inner}>
					...
					<div className={classes.contentNextImage}>
						...
						>
							<List.Item>
								for data collection: Cognitive-Affective Map extended logic
								(C.A.M.E.L.)
							</List.Item>
							<List.Item>for data analysis: CAM-App (Shiny)</List.Item>
							<List.Item>
								for setting up studys with different designs and preprocessing
								steps: administrative panel (you are currently on)
							</List.Item>
						</List>
						...
						<a
							...
							target="_blank"
						>
							<span className={classes.internalLinks}>Documentation</span>
						</a>
						.
					</div>
				</div>

				<Title className={classes.subtitle}>No coding is required:</Title>
				<div className={classes.inner}>
					<div className={classes.contentBelowImage}>
						<List
							mt={30}
						...
						>
							<List.Item>
								It is possible to set up CAM studies using a visual interface
								and all kind of adjustements are possible (see{" "}
								<a
							...
							<List.Item>
								...
								<a
									...
									target="_blank"
								>
									<span className={classes.internalLinks}>example studies</span>
								</a>
								).
							</List.Item>
							<List.Item>
								Using the visual interface of the CAM-App data can be easly
								summarized and analyzed (see{" "}
								<a
				...
				<Title className={classes.subtitle}>Flexible and extensible:</Title>
				<div className={classes.inner}>
					<div className={classes.contentBelowImage}>
						<List
							mt={30}
						...
						>
							...
							<List.Item>
								...
								control. Here it is possible to implement even more advanced
								features (for inspiration see future features sections in the
								documentation).
							</List.Item>
							<List.Item>
								If you want to extend the features of the CAM-App you can freely
								adjust our written functions in R or write your own (check out
								our source code).
							</List.Item>
						</List>
					</div>
				...
				<Title className={classes.subtitle}>There's so much more:</Title>
				<div className={classes.inner}>
					<div className={classes.contentNextImage}>
						<List
							mt={30}
						...
						>
							...
							<List.Item>
								Watch our introductory video online and build your first study
								after we have generated an account for you in minutes.
							</List.Item>
						</List>
					</div>
					<div className={classes.contentNextImage}>
