	...
	return (
		...
		>
			...
			>
				...
				>
					participants joined the experiment
				</Text>
			</div>
			...
			>
				...
				>
					concepts have been drawn so far
				</Text>
			</div>
			...
			>
				<Title style={{ color: avgNodes > 0 ? "green" : "red" }}>
					{avgNodes.toFixed(2)}
				</Title>
				<Text
					style={{
				...
				>
					mean valence over all cams drawn
				</Text>
			</div>
